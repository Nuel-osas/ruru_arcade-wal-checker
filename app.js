class WalAirdropExplorer {
    ...
    async handleSearch() {
        ...
        try {
            ...
            // Convert @username to username.sui
            if (searchTerm.startsWith('@')) {
                searchTerm = searchTerm.substring(1) + '.sui';
                console.log('Converted Twitter handle to SuiNS:', searchTerm);
            }
                        ...
                        <div class="group w-full">
                            <div class="flex flex-col sm:flex-row gap-4 w-full">
                                <div class="bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-ika-pink/20 cursor-pointer border border-white/10 hover:border-ika-pink/30 flex-1"
                                 onclick="window.open('https://suivision.xyz/object/${airdrop.data.objectId}', '_blank'); return false;">
